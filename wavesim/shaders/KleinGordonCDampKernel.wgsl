...
fn KleinGordonCDampKernel(i: u32) { //gosl:kernel
	let ctx = Ctx[0];
	var x: i32;
	var y: i32;
	var z: i32;
	...
	if (Params[0].ThreeD == 1) {
		forceA = LaplacianEdge26(x, y, z, sz.x, sz.y, sz.z, i32(CabPosA), prv, pposA);
		forceB = LaplacianEdge26(x, y, z, sz.x, sz.y, sz.z, i32(CabPosB), prv, pposB);
	} else {
