...
func ElectroweakKernel(i uint32) { //gosl:kernel
	...
	EWWStep(x, y, z, cur, prv, 0, csq, omW, math32.Vec3(j0.X+ym0.X, j0.Y+ym0.Y, j0.Z+ym0.Z), boris)
	EWWStep(x, y, z, cur, prv, 1, csq, omW, math32.Vec3(jx.X+ymx.X, jx.Y+ymx.Y, jx.Z+ymx.Z), boris)
	EWWStep(x, y, z, cur, prv, 2, csq, omW, math32.Vec3(jy.X+ymy.X, jy.Y+ymy.Y, jy.Z+ymy.Z), boris)
	EWWStep(x, y, z, cur, prv, 3, csq, omW, math32.Vec3(jz.X+ymz.X, jz.Y+ymz.Y, jz.Z+ymz.Z), boris)
...
func EWWStep(x, y, z, cur, prv, nu int32, csq float32, om, src math32.Vector3, boris bool) {
	vs := int32(EWW10s) + nu
	vv := int32(EWW10v) + nu
