...
// because there the packet is comparable to v and is NOT a small perturbation:
// it melts the condensate it is passing through down to about a third of the
// vacuum value, and a lighter Z travels faster. Turn Amplitude down to 0.02
// and it sits on the tree-level group velocity to within 1%; the whole
// crossover is worth sweeping interactively. The photon is immune to this at
// any amplitude, since Q annihilates the vacuum and its packet costs the
// condensate nothing.
//
...
// peaking once.
//
// This one sets its own envelope width rather than taking Config.PacketWidth,
...
//
// The amplitude is deliberately large, a quarter of the vacuum value, because
// the source is quadratic in W and vanishes for small packets. Amplitude, not
// overlap, is what sets the signal: narrowing the envelope from 1.5 wl to
// 0.75 wl costs a factor of 260, and raising the amplitude from 0.1 v to 0.25 v
// wins back a factor of 6 for free, since the effect goes as amp^2.
