...
fn MaxwellDampKernel(i: u32) { //gosl:kernel
	...
	var f0 = LaplacianEdge19(x, y, z, sz.x, sz.y, sz.z, i32(A0s), prv, a0pp);
	var fX = LaplacianEdge19(x, y, z, sz.x, sz.y, sz.z, i32(AXs), prv, aXpp);
	var fY = LaplacianEdge19(x, y, z, sz.x, sz.y, sz.z, i32(AYs), prv, aYpp);
	var fZ = LaplacianEdge19(x, y, z, sz.x, sz.y, sz.z, i32(AZs), prv, aZpp);
	f0 = csq * f0;
	var a0vc = f0;
	var a0pc = a0pp + a0vc;
	fX = csq * fX;
