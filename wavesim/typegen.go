...
var _ = types.AddType(&types.Type{Name: "github.com/WaveReality/waves/wavesim.Parameters", IDName: "parameters", Doc: "Parameters contains the full set of simulation parameters,\nfor all equations. These are the bare computational values,\nuploaded to the GPU.\nUse Units to set values relative to a particular set of units.", Fields: []types.Field{{Name: "ThreeD", Doc: "ThreeD runs the 3D version of wave equations, else 1D."}, {Name: "Energy", Doc: "Energy determines if energy is computed (when not necessary)."}, {Name: "Move", Doc: "Move determines if particles actually move according to their momentums."}, {Name: "EM", Doc: "EM determines if EM field coupling is activated."}, {Name: "C", Doc: "C is the speed of light factor. Generally should not exceed 1!"}, {Name: "HiggsMu", Doc: "HiggsMu is the Higgs potential positive multiplier mu_H"}, {Name: "HiggsLambda", Doc: "HiggsLambda is the Higgs potential negative multiplier"}, {Name: "Diff", Doc: "Diff is the particle diffusion rate: how fast to spread distance to neighbors."}, {Name: "Decay", Doc: "Decay is the particle decay rate: portion of neighbor value to\nretain per unit distance."}, {Name: "CSq", Doc: "CSq = C^2"}, {Name: "Inv2CSq", Doc: "Inv2CSq = 1 / 2C^2"}, {Name: "Hbar", Doc: "Hbar = h / 2pi = reduced Planck constant."}, {Name: "Mass", Doc: "Mass is a general mass term, e.g., for the KleinGordon equations.\nIf negative, then M^2 is negative!"}, {Name: "MOverHSq", Doc: "MOverHSq = Mass^2 / Hbar^2 is the mass drag factor in KleinGordon\nand related equations. Note: C^2 factor is added in basic vel += c^2 force"}, {Name: "HSqOver2M", Doc: "HSqOver2M = Hbar^2 / 2 Mass is the factor for Schrodinger's equation."}, {Name: "HEOver2MCSq", Doc: "HEOver2MCSq = (Hbar*e) / (2 Mass * CSq) for computing charge."}, {Name: "Omega0", Doc: "Omega0 is (Mass * Csq) / Hbar -- the angular velocity for\ncomplex-valued oscillator corresponding to the rest mass energy only."}, {Name: "HOverMC", Doc: "HOverMC = (Hbar) / (Mass * C) for computing particle momentum from phase."}, {Name: "MOver2", Doc: "MOver2 = Mass / 2 for computing kinetic energy."}, {Name: "MCSq", Doc: "MCSq = (Mass^2 * C^2) for computing total momentum squared"}, {Name: "C6M2", Doc: "C6M2= (C^6 * Mass^2) is the numerator for computing total particle energy"}, {Name: "E", Doc: "E is the electric charge constant, which determines the\nelectric potential units, C = A s\n0.302822 causes Mu0 and Eps0 to both be 1, if C and Hbar are both 1"}, {Name: "Mu0", Doc: "Mu0 is mu_0, or the permeability of free space, which weights\nthe impact of current on the magnetic vector potential."}, {Name: "Eps0", Doc: "Eps0 is epsilon_0, or the permittivity of free space, which weights\nthe impact of charge on the electrical scalar potential = 1 / (mu0 c^2)"}, {Name: "OneoEps0", Doc: "OneoEps0 = 1 / Eps0"}, {Name: "E2OverH", Doc: "E2OverH = (2 * E) / Hbar"}, {Name: "EOverHSq", Doc: "EOverHSq = E^2 / Hbar^2"}, {Name: "Edges", Doc: "Edges determines how to handle the edges."}}})
