...
var _ = types.AddFunc(&types.Func{Name: "github.com/WaveReality/waves/wavesim.NeighMax26", Doc: "NeighMax26 computes the 3D max magnitude across 26 neighbors,\nfor given x,y,z center coordinates, variable index vidx,\nand cur / prev time index tidx. ctr is the center value.", Args: []string{"x", "y", "z", "vidx", "tidx", "diff"}, Returns: []string{"float32"}})
