...
var _ = types.AddFunc(&types.Func{Name: "github.com/WaveReality/waves/wavesim.NeighMaxPosNeg", Doc: "NeighMaxPosNeg computes the 3D max across 27 neighbors,\nincluding the center which gets abs mag, for given x,y,z center coordinates,\nvariable index xPidx = posX, xNidx = negX, etc.\nand cur / prev time index tidx. ctr is the center value.", Args: []string{"x", "y", "z", "pXidx", "nXidx", "pYidx", "nYidx", "pZidx", "nZidx", "tidx"}, Returns: []string{"float32"}})
