...
var _ = types.AddFunc(&types.Func{Name: "github.com/WaveReality/waves/wavesim.WavePacket", Doc: "WavePacket returns value for a gaussian wave packet for given\nlinear dimension value x and 3D distance d.", Args: []string{"x", "d", "period", "width", "phase", "amp"}, Returns: []string{"float32"}})
