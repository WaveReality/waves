...
fn HiggsKernel(i: u32) { //gosl:kernel
...
; var aV = vec3<f32>(aX, aY, aZ);
; var a0sq = a0 * a0;
; var aVsq = LengthSquared3(aV);
; var aSqD = ehsq * (a0sq - aVsq);
; var hs0a = StateGet(Index5D(TensorStrides[40], TensorStrides[41], TensorStrides[42], TensorStrides[43], TensorStrides[44], u32(z), u32(y), u32(x), u32(HiggsHs0a), u32(prv)));
; var hs0b = StateGet(Index5D(TensorStrides[40], TensorStrides[41], TensorStrides[42],
TensorStrides[43], TensorStrides[44], u32(z), u32(y), u32(x), u32(HiggsHs0b), u32(prv)));
; var hv0a = StateGet(Index5D(TensorStrides[40], TensorStrides[41], TensorStrides[42], TensorStrides[43], TensorStrides[44], u32(z), u32(y), u32(x), u32(HiggsHv0a), u32(prv)));
; var hv0b = StateGet(Index5D(TensorStrides[40], TensorStrides[41], TensorStrides[42],
TensorStrides[43], TensorStrides[44], u32(z), u32(y), u32(x), u32(HiggsHv0b), u32(prv)));
; var hs0aG = Gradient18(x, y, z, i32(hs0a), prv);
; var hs0bG = Gradient18(x, y, z, i32(hs0b), prv);
; var cc = hs0a*hs0a + hs0b*hs0b;
; var hv = cc - musq;
; hv = lambda * hv * hv;
; var hs0aF = Laplacian26(x, y, z, i32(HiggsHs0a), prv, hs0a);
; hs0aF -= hv;
; hs0aF *= csq;
; if (em) {
	var vd = hs0bG*(aV);
	hs0aF += e2h*(a0*hv0b+c*(vd.x+vd.y+vd.z)) + hs0a*aSqD;
}; var hv0aC = hv0a + hs0aF;
; var hs0aC = hs0a + hv0aC;
; var hs0bF = Laplacian26(x, y, z, i32(HiggsHs0b), prv, hs0b);
; hs0bF -= hv;
; hs0bF *= csq;
; if (em) {
	var vd = hs0aG*(aV);
	hs0bF += e2h*(a0*hv0aC+c*(vd.x+vd.y+vd.z)) + hs0b*aSqD; // note: cur hv0aC
}; var hv0bC = hv0b + hs0bF;
; var hs0bC = hs0b + hv0bC;
; StateSet(hs0aC, Index5D(TensorStrides[40], TensorStrides[41], TensorStrides[42], TensorStrides[43], TensorStrides[44], u32(z), u32(y), u32(x), u32(HiggsHs0a), u32(cur)));; StateSet(hs0bC, Index5D(TensorStrides[40], TensorStrides[41], TensorStrides[42], TensorStrides[43], TensorStrides[44], u32(z), u32(y), u32(x), u32(HiggsHs0b), u32(cur)));; StateSet(hv0aC, Index5D(TensorStrides[40], TensorStrides[41], TensorStrides[42], TensorStrides[43], TensorStrides[44], u32(z), u32(y), u32(x), u32(HiggsHv0a), u32(cur)));; StateSet(hv0bC, Index5D(TensorStrides[40], TensorStrides[41], TensorStrides[42], TensorStrides[43], TensorStrides[44], u32(z), u32(y), u32(x), u32(HiggsHv0b), u32(cur)));; StateSet(cc, Index5D(TensorStrides[40], TensorStrides[41], TensorStrides[42], TensorStrides[43], TensorStrides[44], u32(z), u32(y), u32(x), u32(HiggsCC), u32(cur)));; StateSet(hv, Index5D(TensorStrides[40], TensorStrides[41], TensorStrides[42], TensorStrides[43], TensorStrides[44], u32(z), u32(y), u32(x), u32(HiggsV), u32(cur))); }
