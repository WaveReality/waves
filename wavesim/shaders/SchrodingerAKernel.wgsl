...
fn SchrodingerAKernel(i: u32) { //gosl:kernel
	let ctx = Ctx[0];
	var x: i32;
	var y: i32;
	var z: i32;
	...
	var voh = StateGet(Index5D(TensorStrides[40], TensorStrides[41], TensorStrides[42], TensorStrides[43], TensorStrides[44], u32(z), u32(y), u32(x), u32(CabV), u32(prv))) / hbar;
	var lap: f32;
	...
	var velA = -hm*lap + voh*pposB; // first order: the velocity IS the derivative
	...
	StateSet(pposA + velA, Index5D(TensorStrides[40], TensorStrides[41], TensorStrides[42],
	TensorStrides[43], TensorStrides[44], u32(z), u32(y), u32(x), u32(CabAs), u32(cur)));
}
